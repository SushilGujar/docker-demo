...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> encodeUriAttrCharRegExp = <span class="hljs-regexp">/[\x00-\x20"'\(\)*,\/:;&lt;=&gt;?@\[\\\]\{\}\x7f]/g</span>
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> hexEscapeRegExp = <span class="hljs-regexp">/%[0-9A-Fa-f]{2}/</span>
<span class="hljs-keyword">var</span> hexEscapeReplaceRegExp = <span class="hljs-regexp">/%([0-9A-Fa-f]{2})/g</span>
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> nonLatin1RegExp = <span class="hljs-regexp">/[^\x20-\x7e\xa0-\xff]/g</span>
...
CHAR        = &lt;any US-ASCII character (octets 0 - 127)&gt;</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> qescRegExp = <span class="hljs-regexp">/\\([\u0000-\u007f])/g</span>;
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> quoteRegExp = <span class="hljs-regexp">/([\\"])/g</span>
...
OCTET         = &lt;any 8-bit sequence of data&gt;</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> paramRegExp = <span class="hljs-regexp">/; *([!#$%&amp;'\*\+\-\.0-9A-Z\^_`a-z\|~]+) *= *("(?:[ !\x23-\x5b\x5d-\x7e\x80-\xff]|\\[\x20-\x7e])*"|[!#$%&amp;'\*\+\-\.0-9A-Z\^_`a-z\|~]+) */g</span>
<span class="hljs-keyword">var</span> textRegExp = <span class="hljs-regexp">/^[\x20-\x7e\x80-\xff]+$/</span>
...
/ &quot;+&quot; / &quot;-&quot; / &quot;^&quot; / &quot;_&quot; / &quot;<code>&quot; / &quot;{&quot; / &quot;}&quot; / &quot;~&quot; language = ( 2*3ALPHA [ extlang ] ) / 4ALPHA / 5*8ALPHA extlang = *3( &quot;-&quot; 3ALPHA ) value-chars = *( pct-encoded / attr-char ) pct-encoded = &quot;%&quot; HEXDIG HEXDIG attr-char = ALPHA / DIGIT / &quot;!&quot; / &quot;#&quot; / &quot;$&quot; / &quot;&amp;&quot; / &quot;+&quot; / &quot;-&quot; / &quot;.&quot; / &quot;^&quot; / &quot;_&quot; / &quot;</code>&quot; / &quot;|&quot; / &quot;~&quot;</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> extValueRegExp = <span class="hljs-regexp">/^([A-Za-z0-9!#$%&amp;+\-^_`{}~]+)'(?:[A-Za-z]{2,3}(?:-[A-Za-z]{3}){0,3}|[A-Za-z]{4,8}|)'((?:%[0-9A-Fa-f]{2}|[A-Za-z0-9!#$&amp;+\-\.^_`|~])+)$/</span>
...
ext-token        = &lt;the characters in token, followed by &quot;*&quot;&gt;</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-keyword">var</span> dispositionTypeRegExp = <span class="hljs-regexp">/^([!#$%&amp;'\*\+\-\.0-9A-Z\^_`a-z\|~]+) *(?:$|;)/</span>
...
<p>fallback defaults to true</p>
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fallback === <span class="hljs-string">'string'</span> &amp;&amp; nonLatin1RegExp.test(fallback)) {
...
<p>determine if name is suitable for quoted string</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> isQuotedString = textRegExp.test(name)
...
<p>set extended filename parameter</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (hasFallback || !isQuotedString || hexEscapeRegExp.test(name)) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">format</span>(<span class="hljs-params">obj</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (!type || <span class="hljs-keyword">typeof</span> type !== <span class="hljs-string">'string'</span> || !tokenRegExp.test(type)) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">decodefield</span>(<span class="hljs-params">str</span>) </span>{
  <span class="hljs-keyword">var</span> match = extValueRegExp.exec(str)
...
<p>to binary string</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> binary = encoded.replace(hexEscapeReplaceRegExp, pdecode)
...
<p>simple Unicode -&gt; ISO-8859-1 transformation</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">return</span> <span class="hljs-built_in">String</span>(val).replace(nonLatin1RegExp, <span class="hljs-string">'?'</span>)
}
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parse</span>(<span class="hljs-params">string</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> match = dispositionTypeRegExp.exec(string)
...
<p>calculate index to start at</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  index = paramRegExp.lastIndex = match[<span class="hljs-number">0</span>].substr(<span class="hljs-number">-1</span>) === <span class="hljs-string">';'</span>
...
<p>match parameters</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">while</span> (match = paramRegExp.exec(string)) {
