...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules\\express\\lib\\express.js";
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
exports = <span class="hljs-built_in">module</span>.exports = createApplication;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">createApplication</span>(<span class="hljs-params"></span>) </span>{
  ...
  app.request = { <span class="hljs-attr">__proto__</span>: req, <span class="hljs-attr">app</span>: app };
  app.response = { <span class="hljs-attr">__proto__</span>: res, <span class="hljs-attr">app</span>: app };
  app.init();
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
exports.query = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./middleware/query'</span>);
exports.static = <span class="hljs-built_in">require</span>(<span class="hljs-string">'serve-static'</span>);
...
<div class="dox">
<div class="summary">
<p>Replace removed middleware with an appropriate error message.</p>
</div>
<div class="body">
</div>
</div>
