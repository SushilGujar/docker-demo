...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules\\express\\lib\\middleware\\query.js";
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">query</span>(<span class="hljs-params">options</span>) </span>{
  <span class="hljs-keyword">var</span> opts = <span class="hljs-built_in">Object</span>.create(options || <span class="hljs-literal">null</span>);
  <span class="hljs-keyword">var</span> queryparse = qs.parse;
  ...
  <span class="hljs-keyword">if</span> (opts !== <span class="hljs-literal">undefined</span> &amp;&amp; opts.allowPrototypes === <span class="hljs-literal">undefined</span>) {
</pre>
        </td>
      </tr>
...
<p>back-compat for qs module</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">    opts.allowPrototypes = <span class="hljs-literal">true</span>;
  }
  ...
  <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">query</span>(<span class="hljs-params">req, res, next</span>)</span>{
    <span class="hljs-keyword">if</span> (!req.query) {
      <span class="hljs-keyword">var</span> val = parseUrl(req).query;
