...
<p>ignore 404 on in-flight response</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (!err &amp;&amp; res._header) {
...
<p>respect status code from error</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      status = getErrorStatusCode(err) || res.statusCode
...
<p>respect err.headers</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">      <span class="hljs-keyword">if</span> (err.headers &amp;&amp; (err.status === status || err.statusCode === status)) {
...
<p>production gets a basic error message</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">      <span class="hljs-keyword">var</span> msg = env === <span class="hljs-string">'production'</span>
        ? statuses[status]
        : err.stack || err.toString()
      msg = escapeHtml(msg)
        .replace(<span class="hljs-regexp">/\n/g</span>, <span class="hljs-string">'&lt;br&gt;'</span>)
        .replace(<span class="hljs-regexp">/\x20{2}/g</span>, <span class="hljs-string">' &amp;nbsp;'</span>) + <span class="hljs-string">'\n'</span>
    } <span class="hljs-keyword">else</span> {
      status = <span class="hljs-number">404</span>
      msg = <span class="hljs-string">'Cannot '</span> + escapeHtml(req.method) + <span class="hljs-string">' '</span> + escapeHtml(req.originalUrl || req.url) + <span class="hljs-string">'\n'</span>
    }
...
<p>cannot actually respond</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (res._header) {
...
<span class="dox_type">string</span>
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">send</span> (<span class="hljs-params">req, res, status, headers, body</span>) </span>{
...
<p>response headers</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">var</span> keys = <span class="hljs-built_in">Object</span>.keys(headers)
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; keys.length; i++) {
      <span class="hljs-keyword">var</span> key = keys[i]
...
<p>security header for content sniffing</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">    res.setHeader(<span class="hljs-string">'X-Content-Type-Options'</span>, <span class="hljs-string">'nosniff'</span>)
