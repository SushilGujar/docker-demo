...
<head>
  ...
  <script>
    var relativeDir = "../../../../";
    var thisFile = "node_modules\\depd\\lib\\browser\\index.js";
...
<p>no-op in browser</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  }

  deprecate._file = <span class="hljs-literal">undefined</span>
  deprecate._ignored = <span class="hljs-literal">true</span>
  deprecate._namespace = namespace
  deprecate._traced = <span class="hljs-literal">false</span>
...
<div class="body">
<p>This is a no-op version of the wrapper, which does nothing but call
validation.</p>
</div>
</div>
