...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\inherits\\test.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> inherits = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./inherits.js'</span>)
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">test</span>(<span class="hljs-params">c</span>) </span>{
  ...
  assert(<span class="hljs-built_in">Object</span>.getPrototypeOf(c) === Child.prototype)
  assert(<span class="hljs-built_in">Object</span>.getPrototypeOf(<span class="hljs-built_in">Object</span>.getPrototypeOf(c)) === Parent.prototype)
  assert(c <span class="hljs-keyword">instanceof</span> Child)
  assert(c <span class="hljs-keyword">instanceof</span> Parent)
}
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">Child</span>(<span class="hljs-params"></span>) </span>{
  ...
  test(<span class="hljs-keyword">this</span>)
}
